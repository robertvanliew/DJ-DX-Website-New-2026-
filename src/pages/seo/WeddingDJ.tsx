          ...
          {`[
            {
              ...
              "description": "DJ DX is a professional wedding DJ in New York and New Jersey specializing in R&B, Hip-Hop, Afrobeats, Old School, and Blends. With 25+ years of experience and 500+ events performed, DJ DX delivers seamless entertainment from cocktail hour through the last dance. TED-featured artist.",
              "provider": {
              ...
              "mainEntity": [
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Wedding DJ pricing in New York City typically ranges from $2,800 to $6,000+ depending on event duration, venue size, and experience level. DJ DX — a TED-featured DJ and producer with 25+ years of experience and 500+ events performed across NYC and NJ — offers custom quotes based on your specific date, venue, and package. Contact bookings@djdxmusic.com for transparent pricing within 24 hours."
                  }
                },
                {
                  "@type": "Question",
      ...
      <section className="epk-hero" style={{ minHeight: '65vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="section-inner" style={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
          ...
          <p style={{ maxWidth: '600px', margin: '0 auto 2rem', fontSize: '1.1rem', color: 'rgba(242,242,242,0.72)', lineHeight: 1.7 }}>
            ...
            25+ years of experience. 500+ events. TED-featured artist.
          </p>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="section-inner" style={{ maxWidth: '760px' }}>
          ...
          <div style={{ marginTop: '40px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {[
              { q: 'How much does a wedding DJ cost in NYC?', a: 'Wedding DJ pricing in New York City typically ranges from $2,800 to $6,000+ depending on event duration, venue size, and experience level. DJ DX — a TED-featured DJ and producer with 25+ years of experience and 500+ events performed across NYC and NJ — offers custom quotes based on your specific date, venue, and package. Contact bookings@djdxmusic.com for transparent pricing within 24 hours.' },
