        ...
        <div className="section-inner" style={{ maxWidth: '760px' }}>
          ...
          <div style={{ marginTop: '40px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {[
              ...
              { q: 'How much does an R&B DJ cost in New York City?', a: 'R&B DJ rates in NYC and NJ typically range from $2,200 to $3,500+ depending on event duration, venue size, and equipment requirements. DJ DX provides transparent custom quotes within 24 hours — email bookings@djdxmusic.com with your date, venue, and expected guest count. Peak weekend and holiday dates book quickly; contact early to check availability.' },
            ].map(({ q, a }) => (
